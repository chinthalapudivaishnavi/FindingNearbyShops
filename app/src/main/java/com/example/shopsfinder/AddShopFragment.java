 ...
 * Use the {@link AddShopFragment#newInstance} factory method to
...
public class AddShopFragment extends Fragment {
     ...
     * @return A new instance of fragment AddShopFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button addshopbtn=view.findViewById(R.id.addshopbtn);
        addshopbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Intent.ACTION_VIEW);
                intent.setData(Uri.parse("https://www.google.com/business/"));
